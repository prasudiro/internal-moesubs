<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" title="Rilisan"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Rilisan</span></a>
                    </li>
                    <li>
                        <a href="#" title="Proyek"><i class="fa fa-area-chart"></i> <span class="nav-label">Proyek</span></a>
                    </li>
                    <li>
                        <a href="#" title="Kategori"><i class="fa fa-bars"></i> <span class="nav-label">Kategori</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="#" title="Judul Kartun">Judul Kartun</a></li>
                            <li><a href="#" title="Musim Tayang">Musim Tayang</a></li>
                        </ul>
                    </li>
                    <li>
