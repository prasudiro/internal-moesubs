		...
		<div class="modal inmodal" id="myModal{{ $isi['laporan_isi_id']}}" tabindex="-1" role="dialog" aria-hidden="true">
		    ...
		    <div class="modal-content animated bounceInRight">
                    ...
                    @if($user_info['level'] == 3)
                      <a href="{{ URL('laporan/edit/'.base64_encode('laporan'.$isi['laporan_isi_id'].'qc'))}}" data-toggle="tooltip" title="Edit laporan {{ $isi['name']}}"><i class="fa fa-edit text-danger"></i></a>
